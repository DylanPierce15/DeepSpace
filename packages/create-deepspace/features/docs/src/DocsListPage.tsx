/**
 * DocsListPage — List of documents.
 *
 * Shows all documents (stored in RecordRoom) with
 * create and delete functionality.
 *
 * Navigates to /docs/:docId when a document is selected.
 *
 * Installed at: src/pages/docs/index.tsx
 */
