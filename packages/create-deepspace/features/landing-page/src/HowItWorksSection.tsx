 ...
 *
 * Numbered 3-step horizontal flow with a gradient connecting line
 * between step badges on desktop. Staggered scroll-triggered animation.
 *
 * Customize by editing the STEPS array below.
 */
