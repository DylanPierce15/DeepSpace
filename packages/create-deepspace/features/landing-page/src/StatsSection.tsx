 ...
 *
 * Full-width gradient band with animated counter stats. Each number
 * counts up from 0 when scrolled into view. Supports prefixes (<, >)
 * and suffixes (%, x, +, ms, K, M).
 *
 * Customize by editing the STATS array below.
 */
