 ...
 *
 * 3-column grid of testimonial cards with star ratings, quotes,
 * and author info. Glassmorphic cards with staggered scroll reveal.
 *
 * Customize by editing the TESTIMONIALS array below.
 */
  ...
  return (
    <section id="testimonials" className="relative py-28 md:py-36">
      <div className="max-w-6xl mx-auto px-6">
        <SectionHeading
          tag="Testimonials"
          title="Loved by people everywhere"
        />
